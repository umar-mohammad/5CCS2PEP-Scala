...
// println(run("[-]", Map(0 -> 100)) == Map(0 -> 0))
// println(run("[->+<]", Map(0 -> 10)) == Map(0 -> 0, 1 -> 10))
// println(run("[>>+>>+<<<<-]", Map(0 -> 42)) == Map(0 -> 0, 2 -> 42, 4 -> 42))
// println(run("++++++++++#>+***#") == Map(0 -> 10, 1 -> 1000))
// println(run("+++>+@+@+@+@+@") == Map(0 -> 3, 1 -> 7, 4 -> 3, 5 -> 3, 6 -> 3, 7 -> 3))
// println(run("""+++++[->++++++++++<]>--<+++[->>++++++++++<<]>>++<<----------[+>.>.<+<]""") == Map(0 -> 0, 1 -> 58, 2 -> 32))
...
// clears the 0-cell
// println(run("[-]", Map(0 -> 100)))   // Map will be 0 -> 0
...
//
// println(run(load_bff("benchmark.bf")))

// calculates the Collatz series for numbers from 1 to 30
//
// println(run(load_bff("collatz.bf")))
}
